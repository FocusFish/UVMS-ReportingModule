...
public class ServiceLayerUtils {
    ...
    public static Collection<String> getUserPermittedLayersNames(USMService usmService, String username, String roleName, String scopeName) throws fish.focus.uvms.exception.ServiceException {
