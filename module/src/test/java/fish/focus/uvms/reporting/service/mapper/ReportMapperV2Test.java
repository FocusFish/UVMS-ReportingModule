...
import fish.focus.uvms.reporting.service.mapper.ReportMapperV2;
...
public class ReportMapperV2Test {
    ...
    public void testReportDtoToReport() throws IOException {
        ...
        fish.focus.uvms.reporting.service.entities.Report entity = ReportMapperV2.INSTANCE.reportDtoToReport(report);
