...
public class MovementData {
    ...
    Map<String, fish.focus.wsdl.asset.types.Asset> assetMap;
    ...
    public Map<String, fish.focus.wsdl.asset.types.Asset> getAssetMap() {
        return assetMap;
    }

    public void setAssetMap(Map<String, fish.focus.wsdl.asset.types.Asset> assetMap) {
